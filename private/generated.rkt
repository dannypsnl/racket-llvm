...
(define-llvm llvm-add-incoming (_fun _LLVMValueRef _pointer _pointer _uint -> _void) #:c-id LLVMAddIncoming)
...
(define-llvm llvm-append-basic-block-in-context (_fun _LLVMContextRef _LLVMValueRef _string -> _LLVMBasicBlockRef) #:c-id LLVMAppendBasicBlockInContext)
...
(define-llvm llvm-build-a-shr (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildAShr)
(define-llvm llvm-build-add (_fun  (builder lhs rhs [name ""]) ::
                                     ...
                                     -> _LLVMValueRef)
  #:c-id LLVMBuildAdd)
(define-llvm llvm-build-addr-space-cast (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildAddrSpaceCast)
(define-llvm llvm-build-aggregate-ret (_fun _LLVMBuilderRef _pointer _uint -> _LLVMValueRef) #:c-id LLVMBuildAggregateRet)
(define-llvm llvm-build-alloca (_fun _LLVMBuilderRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildAlloca)
(define-llvm llvm-build-and (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildAnd)
(define-llvm llvm-build-array-alloca (_fun _LLVMBuilderRef _LLVMTypeRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildArrayAlloca)
(define-llvm llvm-build-array-malloc (_fun _LLVMBuilderRef _LLVMTypeRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildArrayMalloc)
(define-llvm llvm-build-atomic-cmp-xchg (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _LLVMValueRef _uint _uint _int -> _LLVMValueRef) #:c-id LLVMBuildAtomicCmpXchg)
...
(define-llvm llvm-build-atomic-rmw (_fun _LLVMBuilderRef _uint _LLVMValueRef _LLVMValueRef _uint _int -> _LLVMValueRef) #:c-id LLVMBuildAtomicRMW)
...
(define-llvm llvm-build-bin-op (_fun _LLVMBuilderRef _uint _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildBinOp)
(define-llvm llvm-build-bit-cast (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildBitCast)
...
(define-llvm llvm-build-call2 (_fun  (builder fn-ty fn args [name ""]) ::
                                     ...
                                     -> _LLVMValueRef)
  #:c-id LLVMBuildCall2)
(define-llvm llvm-build-call-br (_fun _LLVMBuilderRef _LLVMTypeRef _LLVMValueRef _LLVMBasicBlockRef _pointer _uint _pointer _uint _pointer _uint _string -> _LLVMValueRef) #:c-id LLVMBuildCallBr)
(define-llvm llvm-build-call-with-operand-bundles (_fun _LLVMBuilderRef _LLVMTypeRef _LLVMValueRef _pointer _uint _pointer _uint _string -> _LLVMValueRef) #:c-id LLVMBuildCallWithOperandBundles)
(define-llvm llvm-build-cast (_fun _LLVMBuilderRef _uint _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildCast)
(define-llvm llvm-build-catch-pad (_fun _LLVMBuilderRef _LLVMValueRef _pointer _uint _string -> _LLVMValueRef) #:c-id LLVMBuildCatchPad)
...
(define-llvm llvm-build-catch-switch (_fun _LLVMBuilderRef _LLVMValueRef _LLVMBasicBlockRef _uint _string -> _LLVMValueRef) #:c-id LLVMBuildCatchSwitch)
(define-llvm llvm-build-cleanup-pad (_fun _LLVMBuilderRef _LLVMValueRef _pointer _uint _string -> _LLVMValueRef) #:c-id LLVMBuildCleanupPad)
...
(define-llvm llvm-build-exact-s-div (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildExactSDiv)
(define-llvm llvm-build-exact-u-div (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildExactUDiv)
(define-llvm llvm-build-extract-element (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildExtractElement)
(define-llvm llvm-build-extract-value (_fun _LLVMBuilderRef _LLVMValueRef _uint _string -> _LLVMValueRef) #:c-id LLVMBuildExtractValue)
(define-llvm llvm-build-f-add (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildFAdd)
(define-llvm llvm-build-f-cmp (_fun  (builder predicate lhs rhs [name ""]) ::
                                        (builder : _LLVMBuilderRef)
                                        ...
                                        -> _LLVMValueRef)
  #:c-id LLVMBuildFCmp)
(define-llvm llvm-build-f-div (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildFDiv)
(define-llvm llvm-build-f-mul (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildFMul)
(define-llvm llvm-build-f-neg (_fun _LLVMBuilderRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildFNeg)
(define-llvm llvm-build-fp-cast (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildFPCast)
(define-llvm llvm-build-fp-ext (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildFPExt)
(define-llvm llvm-build-fp-to-si (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildFPToSI)
(define-llvm llvm-build-fp-to-ui (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildFPToUI)
(define-llvm llvm-build-fp-trunc (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildFPTrunc)
(define-llvm llvm-build-f-rem (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildFRem)
(define-llvm llvm-build-f-sub (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildFSub)
(define-llvm llvm-build-fence (_fun _LLVMBuilderRef _uint _int _string -> _LLVMValueRef) #:c-id LLVMBuildFence)
(define-llvm llvm-build-fence-sync-scope (_fun _LLVMBuilderRef _uint _uint _string -> _LLVMValueRef) #:c-id LLVMBuildFenceSyncScope)
(define-llvm llvm-build-free (_fun _LLVMBuilderRef _LLVMValueRef -> _LLVMValueRef) #:c-id LLVMBuildFree)
(define-llvm llvm-build-freeze (_fun _LLVMBuilderRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildFreeze)
(define-llvm llvm-build-ge2 (_fun _LLVMBuilderRef _LLVMTypeRef _LLVMValueRef _pointer _uint _string -> _LLVMValueRef) #:c-id LLVMBuildGEP2)
(define-llvm llvm-build-gep-with-no-wrap-flags (_fun _LLVMBuilderRef _LLVMTypeRef _LLVMValueRef _pointer _uint _string _uint -> _LLVMValueRef) #:c-id LLVMBuildGEPWithNoWrapFlags)
(define-llvm llvm-build-global-string (_fun _LLVMBuilderRef _string _string -> _LLVMValueRef) #:c-id LLVMBuildGlobalString)
...
(define-llvm llvm-build-i-cmp (_fun  (builder predicate lhs rhs [name ""]) ::
                                        (builder : _LLVMBuilderRef)
                                        ...
                                        -> _LLVMValueRef)
  #:c-id LLVMBuildICmp)
(define-llvm llvm-build-in-bounds-ge2 (_fun _LLVMBuilderRef _LLVMTypeRef _LLVMValueRef _pointer _uint _string -> _LLVMValueRef) #:c-id LLVMBuildInBoundsGEP2)
(define-llvm llvm-build-indirect-br (_fun _LLVMBuilderRef _LLVMValueRef _uint -> _LLVMValueRef) #:c-id LLVMBuildIndirectBr)
(define-llvm llvm-build-insert-element (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildInsertElement)
(define-llvm llvm-build-insert-value (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _uint _string -> _LLVMValueRef) #:c-id LLVMBuildInsertValue)
(define-llvm llvm-build-int-cast (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildIntCast)
(define-llvm llvm-build-int-cast2 (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _int _string -> _LLVMValueRef) #:c-id LLVMBuildIntCast2)
(define-llvm llvm-build-int-to-ptr (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildIntToPtr)
(define-llvm llvm-build-invoke2 (_fun _LLVMBuilderRef _LLVMTypeRef _LLVMValueRef _pointer _uint _LLVMBasicBlockRef _LLVMBasicBlockRef _string -> _LLVMValueRef) #:c-id LLVMBuildInvoke2)
(define-llvm llvm-build-invoke-with-operand-bundles (_fun _LLVMBuilderRef _LLVMTypeRef _LLVMValueRef _pointer _uint _LLVMBasicBlockRef _LLVMBasicBlockRef _pointer _uint _string -> _LLVMValueRef) #:c-id LLVMBuildInvokeWithOperandBundles)
(define-llvm llvm-build-is-not-null (_fun _LLVMBuilderRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildIsNotNull)
(define-llvm llvm-build-is-null (_fun _LLVMBuilderRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildIsNull)
(define-llvm llvm-build-l-shr (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildLShr)
(define-llvm llvm-build-landing-pad (_fun _LLVMBuilderRef _LLVMTypeRef _LLVMValueRef _uint _string -> _LLVMValueRef) #:c-id LLVMBuildLandingPad)
(define-llvm llvm-build-load2 (_fun _LLVMBuilderRef _LLVMTypeRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildLoad2)
(define-llvm llvm-build-malloc (_fun _LLVMBuilderRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildMalloc)
...
(define-llvm llvm-build-mul (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildMul)
(define-llvm llvm-build-nsw-add (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildNSWAdd)
(define-llvm llvm-build-nsw-mul (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildNSWMul)
(define-llvm llvm-build-nsw-neg (_fun _LLVMBuilderRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildNSWNeg)
(define-llvm llvm-build-nsw-sub (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildNSWSub)
(define-llvm llvm-build-nuw-add (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildNUWAdd)
(define-llvm llvm-build-nuw-mul (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildNUWMul)
(define-llvm llvm-build-nuw-neg (_fun _LLVMBuilderRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildNUWNeg)
(define-llvm llvm-build-nuw-sub (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildNUWSub)
(define-llvm llvm-build-neg (_fun _LLVMBuilderRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildNeg)
(define-llvm llvm-build-not (_fun _LLVMBuilderRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildNot)
(define-llvm llvm-build-or (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildOr)
(define-llvm llvm-build-phi (_fun _LLVMBuilderRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildPhi)
(define-llvm llvm-build-pointer-cast (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildPointerCast)
(define-llvm llvm-build-ptr-diff2 (_fun _LLVMBuilderRef _LLVMTypeRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildPtrDiff2)
(define-llvm llvm-build-ptr-to-int (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildPtrToInt)
...
(define-llvm llvm-build-s-div (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildSDiv)
(define-llvm llvm-build-s-ext (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildSExt)
(define-llvm llvm-build-s-ext-or-bit-cast (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildSExtOrBitCast)
(define-llvm llvm-build-si-to-fp (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildSIToFP)
(define-llvm llvm-build-s-rem (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildSRem)
(define-llvm llvm-build-select (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildSelect)
(define-llvm llvm-build-shl (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildShl)
(define-llvm llvm-build-shuffle-vector (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildShuffleVector)
(define-llvm llvm-build-store (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef -> _LLVMValueRef) #:c-id LLVMBuildStore)
(define-llvm llvm-build-struct-ge2 (_fun _LLVMBuilderRef _LLVMTypeRef _LLVMValueRef _uint _string -> _LLVMValueRef) #:c-id LLVMBuildStructGEP2)
(define-llvm llvm-build-sub (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildSub)
...
(define-llvm llvm-build-trunc (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildTrunc)
(define-llvm llvm-build-trunc-or-bit-cast (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildTruncOrBitCast)
(define-llvm llvm-build-u-div (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildUDiv)
(define-llvm llvm-build-ui-to-fp (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildUIToFP)
(define-llvm llvm-build-u-rem (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildURem)
(define-llvm llvm-build-unreachable (_fun _LLVMBuilderRef -> _LLVMValueRef) #:c-id LLVMBuildUnreachable)
(define-llvm llvm-build-va-arg (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildVAArg)
(define-llvm llvm-build-xor (_fun _LLVMBuilderRef _LLVMValueRef _LLVMValueRef _string -> _LLVMValueRef) #:c-id LLVMBuildXor)
(define-llvm llvm-build-z-ext (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildZExt)
(define-llvm llvm-build-z-ext-or-bit-cast (_fun _LLVMBuilderRef _LLVMValueRef _LLVMTypeRef _string -> _LLVMValueRef) #:c-id LLVMBuildZExtOrBitCast)
...
(define-llvm llvm-const-array (_fun _LLVMTypeRef _pointer _uint -> _LLVMValueRef) #:c-id LLVMConstArray)
(define-llvm llvm-const-array2 (_fun _LLVMTypeRef _pointer _uint64 -> _LLVMValueRef) #:c-id LLVMConstArray2)
...
(define-llvm llvm-const-ge2 (_fun _LLVMTypeRef _LLVMValueRef _pointer _uint -> _LLVMValueRef) #:c-id LLVMConstGEP2)
...
(define-llvm llvm-const-in-bounds-ge2 (_fun _LLVMTypeRef _LLVMValueRef _pointer _uint -> _LLVMValueRef) #:c-id LLVMConstInBoundsGEP2)
(define-llvm llvm-const-inline-asm (_fun _LLVMTypeRef _string _string _int _int -> _LLVMValueRef) #:c-id LLVMConstInlineAsm)
...
(define-llvm llvm-const-named-struct (_fun _LLVMTypeRef _pointer _uint -> _LLVMValueRef) #:c-id LLVMConstNamedStruct)
...
(define-llvm llvm-const-string (_fun _string _uint _int -> _LLVMValueRef) #:c-id LLVMConstString)
(define-llvm llvm-const-string-in-context (_fun _LLVMContextRef _string _uint _int -> _LLVMValueRef) #:c-id LLVMConstStringInContext)
(define-llvm llvm-const-string-in-context2 (_fun _LLVMContextRef _string _ulong _int -> _LLVMValueRef) #:c-id LLVMConstStringInContext2)
(define-llvm llvm-const-struct (_fun _pointer _uint _int -> _LLVMValueRef) #:c-id LLVMConstStruct)
(define-llvm llvm-const-struct-in-context (_fun _LLVMContextRef _pointer _uint _int -> _LLVMValueRef) #:c-id LLVMConstStructInContext)
...
(define-llvm llvm-const-vector (_fun _pointer _uint -> _LLVMValueRef) #:c-id LLVMConstVector)
...
(define-llvm llvm-context-set-discard-value-names (_fun _LLVMContextRef _int -> _void) #:c-id LLVMContextSetDiscardValueNames)
...
(define-llvm llvm-create-operand-bundle (_fun _string _ulong _pointer _uint -> _LLVMOperandBundleRef) #:c-id LLVMCreateOperandBundle)
...
(define-llvm llvm-get-inline-asm (_fun _LLVMTypeRef _string _ulong _string _ulong _int _int _uint _int -> _LLVMValueRef) #:c-id LLVMGetInlineAsm)
...
(define-llvm llvm-is-constant (_fun _LLVMValueRef -> _int) #:c-id LLVMIsConstant)
(define-llvm llvm-is-constant-string (_fun _LLVMValueRef -> _int) #:c-id LLVMIsConstantString)
...
(define-llvm llvm-is-poison (_fun _LLVMValueRef -> _int) #:c-id LLVMIsPoison)
...
(define-llvm llvm-is-undef (_fun _LLVMValueRef -> _int) #:c-id LLVMIsUndef)
...
(define-llvm llvmmd-node-in-context2 (_fun _LLVMContextRef _pointer _ulong -> _LLVMMetadataRef) #:c-id LLVMMDNodeInContext2)
...
(define-llvm llvm-pass-builder-options-set-forget-all-scev-in-loop-unroll (_fun _LLVMPassBuilderOptionsRef _int -> _void) #:c-id LLVMPassBuilderOptionsSetForgetAllSCEVInLoopUnroll)
...
(define-llvm llvm-pass-builder-options-set-loop-interleaving (_fun _LLVMPassBuilderOptionsRef _int -> _void) #:c-id LLVMPassBuilderOptionsSetLoopInterleaving)
(define-llvm llvm-pass-builder-options-set-loop-unrolling (_fun _LLVMPassBuilderOptionsRef _int -> _void) #:c-id LLVMPassBuilderOptionsSetLoopUnrolling)
(define-llvm llvm-pass-builder-options-set-loop-vectorization (_fun _LLVMPassBuilderOptionsRef _int -> _void) #:c-id LLVMPassBuilderOptionsSetLoopVectorization)
(define-llvm llvm-pass-builder-options-set-merge-functions (_fun _LLVMPassBuilderOptionsRef _int -> _void) #:c-id LLVMPassBuilderOptionsSetMergeFunctions)
(define-llvm llvm-pass-builder-options-set-slp-vectorization (_fun _LLVMPassBuilderOptionsRef _int -> _void) #:c-id LLVMPassBuilderOptionsSetSLPVectorization)
(define-llvm llvm-pass-builder-options-set-verify-each (_fun _LLVMPassBuilderOptionsRef _int -> _void) #:c-id LLVMPassBuilderOptionsSetVerifyEach)
...
(define-llvm llvm-set-cleanup (_fun _LLVMValueRef _int -> _void) #:c-id LLVMSetCleanup)
...
(define-llvm llvm-set-exact (_fun _LLVMValueRef _int -> _void) #:c-id LLVMSetExact)
...
(define-llvm llvm-set-global-constant (_fun _LLVMValueRef _int -> _void) #:c-id LLVMSetGlobalConstant)
...
(define-llvm llvm-set-tail-call (_fun _LLVMValueRef _int -> _void) #:c-id LLVMSetTailCall)
...
(define-llvm llvm-set-thread-local (_fun _LLVMValueRef _int -> _void) #:c-id LLVMSetThreadLocal)
(define-llvm llvm-set-thread-local-mode (_fun _LLVMValueRef _uint -> _void) #:c-id LLVMSetThreadLocalMode)
(define-llvm llvm-set-unnamed-addr (_fun _LLVMValueRef _int -> _void) #:c-id LLVMSetUnnamedAddr)
...
(define-llvm llvm-set-volatile (_fun _LLVMValueRef _int -> _void) #:c-id LLVMSetVolatile)
(define-llvm llvm-set-weak (_fun _LLVMValueRef _int -> _void) #:c-id LLVMSetWeak)
...
(define-llvm llvm-struct-type (_fun _pointer _uint _bool -> _LLVMTypeRef) #:c-id LLVMStructType)
(define-llvm llvm-struct-type-in-context (_fun _LLVMContextRef _pointer _uint _bool -> _LLVMTypeRef) #:c-id LLVMStructTypeInContext)
...
(define-llvm llvm-temporary-md-node (_fun _LLVMContextRef _pointer _ulong -> _LLVMMetadataRef) #:c-id LLVMTemporaryMDNode)
...
(define-llvm llvm-type-of (_fun _LLVMValueRef -> _LLVMTypeRef) #:c-id LLVMTypeOf)
...
(define llvm-build-int-cmp llvm-build-i-cmp)
